...
Terminal state: inside a plan, return to executing-plans for the next task. Outside a plan, invoke adversarial-review on the code once the change is committed.
