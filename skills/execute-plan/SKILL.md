...
Terminal state: ask "Continue with code review?" On yes, invoke the `dietpowers:review` skill on the code. Otherwise, report what is built and what is uncommitted, and stop.
